          ...
          <div className="container">
            ...
            <div className="row g-4">
              <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div className="classNamees-item">
                  <div className="bg-light rounded-circle w-75 mx-auto p-3">
                    <img className="img-fluid rounded-circle" src="ui/img/classNamees-1.jpg" alt="" />
                  </div>
              ...
              <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div className="classNamees-item">
                  <div className="bg-light rounded-circle w-75 mx-auto p-3">
                    <img className="img-fluid rounded-circle" src="ui/img/classNamees-2.jpg" alt="" />
                  </div>
                  <div className="bg-light rounded p-4 pt-5 mt-n5">
              ...
              <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div className="classNamees-item">
                  <div className="bg-light rounded-circle w-75 mx-auto p-3">
                    <img className="img-fluid rounded-circle" src="ui/img/classNamees-3.jpg" alt="" />
                  </div>
                  <div className="bg-light rounded p-4 pt-5 mt-n5">
              ...
              <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div className="classNamees-item">
                  <div className="bg-light rounded-circle w-75 mx-auto p-3">
                    <img className="img-fluid rounded-circle" src="ui/img/classNamees-4.jpg" alt="" />
                  </div>
                  <div className="bg-light rounded p-4 pt-5 mt-n5">
              ...
              <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div className="classNamees-item">
                  <div className="bg-light rounded-circle w-75 mx-auto p-3">
                    <img className="img-fluid rounded-circle" src="ui/img/classNamees-5.jpg" alt="" />
                  </div>
                  <div className="bg-light rounded p-4 pt-5 mt-n5">
              ...
              <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div className="classNamees-item">
                  <div className="bg-light rounded-circle w-75 mx-auto p-3">
                    <img className="img-fluid rounded-circle" src="ui/img/classNamees-6.jpg" alt="" />
                  </div>
                  <div className="bg-light rounded p-4 pt-5 mt-n5">
            ...
            <div className="bg-light rounded">
              <div className="row g-0">
                ...
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style={{ minHeight: "400px" }}>
                  <div className="position-relative h-100">
                    <img className="position-absolute w-100 h-100 rounded" src="ui/img/appointment.jpg" style={{ objectFit: "cover" }} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
              <div className="testimonial-item bg-light rounded p-5">
                ...
                <div className="d-flex align-items-center bg-white me-n5" style={{ borderRadius: "50px 0 0 50px" }}>
                  <img className="img-fluid flex-shrink-0 rounded-circle" src="ui/img/testimonial-1.jpg" style={{ width: "90px", height: "90px" }} />
                  <div className="ps-3">
              ...
              <div className="testimonial-item bg-light rounded p-5">
                <p className="fs-5">Tempor stet labore dolor clita stet diam amet ipsum dolor duo ipsum rebum stet dolor amet diam stet. Est stet ea lorem amet est kasd kasd erat eos</p>
                <div className="d-flex align-items-center bg-white me-n5" style={{ borderRadius: "50px 0 0 50px" }}>
                  <img className="img-fluid flex-shrink-0 rounded-circle" src="ui/img/testimonial-2.jpg" style={{ width: "90px", height: "90px" }} />
                  <div className="ps-3">
                    <h3 className="mb-1">Client Name</h3>
                    <span>Profession</span>
                  </div>
              ...
              <div className="testimonial-item bg-light rounded p-5">
                <p className="fs-5">Tempor stet labore dolor clita stet diam amet ipsum dolor duo ipsum rebum stet dolor amet diam stet. Est stet ea lorem amet est kasd kasd erat eos</p>
                <div className="d-flex align-items-center bg-white me-n5" style={{ borderRadius: "50px 0 0 50px" }}>
                  <img className="img-fluid flex-shrink-0 rounded-circle" src="ui/img/testimonial-3.jpg" style={{ width: "90px", height: "90px" }} />
                  <div className="ps-3">
                    <h3 className="mb-1">Client Name</h3>
                    <span>Profession</span>
                  </div>
          ...
          <div className="container py-5">
            <div className="row g-5">
              <div className="col-lg-3 col-md-6">
                ...
                <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>Adarsh Mall, Kolhar Road, Georai</p>
                <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>+072 764 67230</p>
                <p className="mb-2"><i className="fa fa-envelope me-3"></i>abhinav@school.com</p>
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="row g-2 pt-2">
                  <div className="col-4">
                    <img className="img-fluid rounded bg-light p-1" src="ui/img/classes-1.jpg" alt="" />
                  </div>
                  <div className="col-4">
                    <img className="img-fluid rounded bg-light p-1" src="ui/img/classes-2.jpg" alt="" />
                  </div>
                  <div className="col-4">
                    <img className="img-fluid rounded bg-light p-1" src="ui/img/classes-3.jpg" alt="" />
                  </div>
                  <div className="col-4">
                    <img className="img-fluid rounded bg-light p-1" src="ui/img/classes-4.jpg" alt="" />
                  </div>
                  <div className="col-4">
                    <img className="img-fluid rounded bg-light p-1" src="ui/img/classes-5.jpg" alt="" />
                  </div>
                  <div className="col-4">
                    <img className="img-fluid rounded bg-light p-1" src="ui/img/classes-6.jpg" alt="" />
                  </div>
                </div>
              </div>
              <div className="col-lg-3 col-md-6">
